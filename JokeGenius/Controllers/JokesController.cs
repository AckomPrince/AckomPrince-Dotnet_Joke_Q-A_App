...
namespace JokeGenius.Controllers
{
    public class JokesController : Controller
    {
        private readonly MvcJokeContext _context;

        public JokesController(MvcJokeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Joke != null ?
                        ...
                        Problem("Entity set 'MvcJokeContext.Joke'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcJokeContext.Joke'  is null.");
            }
            var joke = await _context.Joke.FindAsync(id);
            if (joke != null)
            {
